        ...
        <div className={pageStructure.contentContainer}>
          {isPending ? (
            ...
            <section className="mt-8 rounded-md border border-border bg-surface p-6 text-center shadow-sm">
              ...
              <Link
                href="/sign-in"
                className={`mt-4 ${buttons.primaryButton}`}
              >
                Sign In
              </Link>
            </section>
            ...
            <>
              {confirmationNumber ? (
                ...
                <section className="mb-8 rounded-md border border-success bg-green-50 p-6">
                  <h2 className="mb-1 text-xl font-semibold text-success-dark">
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        readOnly
                        className={`${inputField.input} ${inputField.readOnly} ${inputField.inputHeight}`}
                      />
                    </div>
                    {/* Email */}
                    <div>
          ...
          Left in place after submission too, as a summary of what was entered. */}
              <section className="mb-8">
                ...
                {!needsMembership && (
                  <div className="mt-3 rounded-lg border border-border bg-highlight px-4 py-3 text-sm text-heading-text">
                    <p className="font-medium">
                      An active CCRA membership is required to enter events.
                    </p>
                    <a
                      href="/membership"
                      className={`my-2 ${buttons.primaryButton}`}
                    >
                      Get a membership
                    </a>
                  </div>
