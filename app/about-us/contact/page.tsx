      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="max-w-2xl mx-auto text-center py-16">
          ...
          <p className="text-xl text-stone-600 dark:text-stone-300">
            Have questions about membership, events, or sponsorships? 
        ...
        <div className="grid lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-md border border-stone-200 shadow-sm p-10 dark:border-stone-700 dark:bg-stone-900">
              <h2 className="text-2xl font-semibold text-stone-950 mb-8 dark:text-stone-100">Contact Information</h2>

              <div className="space-y-10">
                {/* Phone */}
                <div className="flex gap-4">
                  <div className="w-10 h-10 rounded-md bg-orange-50 flex items-center justify-center text-2xl flex-shrink-0 dark:bg-orange-950/40">
                    <Phone className="w-5 h-5 text-orange-600 dark:text-orange-400" />
                  </div>
                  <div>
                    <div className="font-semibold text-stone-950 dark:text-stone-100">Phone</div>
                    <a href="tel:4038753242" className="text-orange-600 hover:underline text-lg dark:text-orange-400">
                      403-875-3242
                    </a>
                    <p className="text-sm text-stone-500 mt-1 dark:text-stone-400">Monday – Friday, 9am – 5pm MST</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:canclassicrodeo@gmail.com" className="text-orange-600 hover:underline text-lg dark:text-orange-400">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-stone-950 dark:text-stone-100">Mailing Address</div>
                    <div className="text-stone-600 leading-relaxed mt-1 dark:text-stone-300">
                      Canadian Classic Rodeo Association<br />
                      PO Box 1234<br />
          ...
          <div className="lg:col-span-7">
            <div className="bg-white rounded-md border border-stone-200 shadow-sm p-10 dark:border-stone-700 dark:bg-stone-900">
              <h2 className="text-2xl font-semibold text-stone-950 mb-8 dark:text-stone-100">Send Us a Message</h2>
              
              <form className="space-y-8">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-stone-700 mb-2 dark:text-stone-300">First Name</label>
                    <input 
                      type="text" 
                  ...
                  <div>
                    <label className="block text-sm font-medium text-stone-700 mb-2 dark:text-stone-300">Last Name</label>
                    <input 
                      type="text" 
                      className="h-12 w-full rounded-md border border-stone-200 bg-white px-4 text-sm text-stone-900 focus:border-orange-300 focus:outline-none focus:ring-1 focus:ring-orange-300 transition dark:border-stone-700 dark:bg-stone-950 dark:text-stone-100"
                ...
                <div>
                  <label className="block text-sm font-medium text-stone-700 mb-2 dark:text-stone-300">Email Address</label>
                  <input 
                    type="email" 
                    className="h-12 w-full rounded-md border border-stone-200 bg-white px-4 text-sm text-stone-900 focus:border-orange-300 focus:outline-none focus:ring-1 focus:ring-orange-300 transition dark:border-stone-700 dark:bg-stone-950 dark:text-stone-100"
                ...
                <div>
                  <label className="block text-sm font-medium text-stone-700 mb-2 dark:text-stone-300">Subject</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-stone-700 mb-2 dark:text-stone-300">Message</label>
                  <textarea 
                    rows={6}
